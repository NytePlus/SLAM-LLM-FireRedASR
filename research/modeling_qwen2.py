...
def eager_attention_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    attn_weights_before_dropout = nn.functional.softmax(attn_weights, dim=-1, dtype=torch.float32).to(query.dtype)
    attn_weights = nn.functional.dropout(attn_weights_before_dropout, p=dropout, training=module.training)
...
class Qwen2DecoderLayer(GradientCheckpointingLayer):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # Self Attention
        hidden_states, attention_map = self.self_attn(
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        hiddens, attention_maps = [hidden_states], [None]
        for decoder_layer in self.layers[: self.config.num_hidden_layers]:
            hidden_states, attention_map = decoder_layer(
                hidden_states,
...
class QwenForResearch(Qwen2PreTrainedModel, GenerationMixin):
