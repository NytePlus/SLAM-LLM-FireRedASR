vc submit -p pdgpu-sjtu-ai -i hub.szaic.com/sjtu/sjtu_yukai-wangchencheng_slm:v2.2 \
    -c 20 -m 360G -g 3 -n 1 \
...
vc submit -p pdgpu-sjtu-ai -i hub.szaic.com/sjtu/sjtu_yukai-wangchencheng_slm:v2.2 -c 16 -m 360G -g 3 -j "mala" -v "/aistor/sjtu/hpc_stor01/home/wangchencheng/workspace/SLAM-LLM-FireRedASR:/workspace,/aistor/sjtu/hpc_stor01/home/wangchencheng/models:/models,/aistor/sjtu/hpc_stor01/home/wangchencheng/data:/data" \
...
docker run -it --rm \
    ...
    hub.szaic.com/sjtu/sjtu_yukai-wangchencheng_slm:v2.2 \
    /bin/bash
