...
python score/normalize.py ${decode_log}_predpart ${decode_log}_norm_predpart
# python score/normalize.py ${decode_log}_gt ${decode_log}_norm_gt

python utils/wenet_compute_cer.py --char=1 -v=1 ${decode_log}_norm_gt ${decode_log}_norm_predpart > ${decode_log}_norm_cerpart
...
python score/score.py --pred ${decode_log}_predpart --multitask ${test_scp_file_path}/multitask.jsonl --norm --lenient > ${decode_log}_norm_werpart
