...
# DATA_DIR=/home/ma-user/work/data MODEL_DIR=/home/ma-user/work/models EXP_DIR=/home/ma-user/work/local_exp ATTN_IMPL=flash_attention_2 bash scripts/cot/finetune.sh

code_dir=.
dataset=slidespeech
task=asr
train_scp_file_path=${DATA_DIR}/${dataset}/train_95/cot
